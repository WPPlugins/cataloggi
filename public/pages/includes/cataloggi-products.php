...
<div class="cataloggi-items">
  <ul id="set-cataloggi-grid-view" class="<?php echo esc_attr( $itemsview ); ?>"> <!-- grid view: cataloggi-item-box-grid columns-3 or list view: cataloggi-item-box-list-view -->
    ...
    ?>
        ...
        <div class="cataloggi-item-price-holder cataloggi-display-block">
		...
		?>
            <div class="payment-button cataloggi-display-block cataloggi-text-align-left cataloggi-margin-bottom-5">
            <?php
        ...
        <div class="item-short-desc cataloggi-display-block">
