...
class CTLGGI_Public {
	...
	public function enqueue_styles() {
	  ...
	  wp_enqueue_style( 'ctlggi-front-end', plugin_dir_url( __FILE__ ) . 'assets/css/ctlggi-front-end.css', array(), $this->version, 'all' );
	  
	  wp_enqueue_style( 'ctlggi-widgets-style', plugin_dir_url( __FILE__ ) . 'assets/css/widgets-style.css', array(), $this->version, 'all' );
	  
	  wp_enqueue_style( 'ctlggi-cataloggi-grid', plugin_dir_url( __FILE__ ) . 'assets/css/cataloggi-grid.css', array(), $this->version, 'all' );
	  
	  wp_enqueue_style( 'ctlggi-table-responsive', plugin_dir_url( __FILE__ ) . 'assets/css/table-responsive.css', array(), $this->version, 'all' );
	  
	  wp_enqueue_style( 'ctlggi-glyphicon', plugins_url() . '/' . $this->plugin_name . '/assets/css/glyphicon.css', array(), $this->version, 'all' );
	  wp_enqueue_style( 'ctlggi-cw-form', plugins_url() . '/' . $this->plugin_name . '/assets/css/cw-form.css', array(), $this->version, 'all' );
      //wp_enqueue_style( 'ctlggi-cw-orange', plugins_url() . '/' . $this->plugin_name . '/assets/css/cw-orange.css', array(), $this->version, 'all' ); // form orange
	  //wp_enqueue_style( 'ctlggi-cw-blue', plugins_url() . '/' . $this->plugin_name . '/assets/css/cw-blue.css', array(), $this->version, 'all' ); // form blue
	}
	...
	public function enqueue_scripts() {
		...
		// Add to cart button
		wp_enqueue_script( 'ctlggi-shopping-cart', plugin_dir_url( __FILE__ ) . 'shopping-cart/assets/js/ctlggi-shopping-cart.js', array( 'jquery' ), $this->version, true );
