...
final class Cataloggi {
	...
	private function load_dependencies() {
		...
		require_once plugin_dir_path( dirname( __FILE__ ) ) . 'admin/classes/class-restrict-mdlibrary.php';
	...
	private function define_admin_hooks() {
		...
		$restrict_md_lib         = new CTLGGI_Restrict_MDLibrary( $this->get_plugin_name(), $this->get_version() );
		...
		$this->loader->add_action( 'pre_get_posts', $restrict_md_lib, 'ctlggi_restrick_users_view_own_attachments', 10, 1 );
	...
	private function define_public_hooks() {
		...
		$this->loader->add_action( 'wp_head', $plugin_public, 'ctlggi_google_analytics_code' ); // Google Analytics
		...
		$this->loader->add_action( 'wp_enqueue_scripts', $plugin_public, 'enqueue_styles' ); // ### Important! Load style after theme style (15)
